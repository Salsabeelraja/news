        ...
        if (response.isSuccessful) {
            response.body()?.let { resultResponse ->
                ...
                if (breakingNewsResponse == null) {
                    ...
                    val old_articles = breakingNewsResponse?.articles
                    val new_articles = resultResponse.articles
                    old_articles?.addAll(new_articles)
                }
        ...
        if (response.isSuccessful) {
            response.body()?.let { resultResponse ->
                ...
                if (searchNewsResponse == null) {
                    ...
                    val old_articles = searchNewsResponse?.articles
                    val new_articles = resultResponse.articles
                    old_articles?.addAll(new_articles)
                }
